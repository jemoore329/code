...
function full_dumper {
  mysql --default-character-set=utf8 -B -u evoqu -pvalaskala1000 mysql -htoolsdb.shopadvisor.com -e "SELECT * FROM $1 where place_id > 1000" | sed 's/	/|/g' |tail -n +2 > jon.pipe 
}

full_dumper "beacons.places"
